  ...
  return (
    <div className="client-verification">
      {!sent ? <form onSubmit={requestCode} className="booking-modal__form booking-modal__form--single">
        ...
        {notRegistered ? <div className="verification-registration" role="alert"><strong>New client? Please register first.</strong><p>Message Shera to create your client profile and add your class package. Once that is complete, you can return here and book online.</p><a className="button secondary" href="contact.html?topic=registration">Message Shera to Register</a></div> : error && <div className="booking-status booking-status--error" role="alert">{error.message}</div>}
